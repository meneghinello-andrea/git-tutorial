...
Lo strumento che permette di configuare Git si chiama ''git config'' e consiste in variabili che contengono i valori delle nostre configurazioni. Queste variabili possono trovarsi in un:
...
\input{Configurazione/Sottosezioni/IdentitaPersonale.tex}

\input{Configurazione/Sottosezioni/Editor.tex}

\input{Configurazione/Sottosezioni/Diff.tex}

\input{Configurazione/Sottosezioni/Alias.tex}

\input{Configurazione/Sottosezioni/Visualizzazione.tex}

\input{Configurazione/Sottosezioni/Colorazione.tex}
